...
\\Construct Ecalhat
\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
eta0=ffgen('x^2 + Mod(3,q), 'eta0); \\eta is predefined
beta=eta0+1;
Ecalhat=ellinit([0,beta], eta0);
if(!(ellcard(Ecalhat) == (q^2-q+1)), error("assertion failed")); 
if(!((q^2-q+1) % p == 0), error("assertion failed")); 
...
nu=ffgen(root);
bCal=(1579068720131648942720078455656310773074752682189626704073136042532690845866515755228530304718*root^2 +     4581727373665814458881199404108521279143490971182947103932047139724242629117010257278337181242)*root +     (1863714896694460132915469204283761501615857581610826279741681680158489049360020519774904286679*root^2 +     6018993779663854272341694592090289123781211508552699798952940528645977640738820382310757124661);
aCal= (3441720760619346169788335177559000968998067714462269923929891758089056900959282481485131184817*root^2 +     4433126477580285416300824744983692266263999436623601882977515525042106518822495174161423655533)*root +     (5403286718293628588466310798786335333137092521468306632377305479733936489451502241320311856517*root^2 +    5628133598253202686598669176746454764851328357278419730653467047944716433197453684173585763401);
ECal=ellinit([aCal,bCal], nu);
if(!(ellmul(ECal, random(ECal), (p^2+1)^2) == [0]), error("assertion failed")); 
